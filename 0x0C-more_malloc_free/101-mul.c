...
/**
 * Error - Basically just prints Error
...
/**
 * allDigits - Checks if all characters are digits
...
/**
 * _calloc- Initializes memory addresses with zero
 * @nmemb: Array of characters
 * @size: String concatenated to nmemb
 ...
 * Return: Product else Error code
 */
